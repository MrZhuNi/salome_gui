...
# PROP Intermediate_Dir "..\..\win32\obj\CAF"
...
# ADD CPP /nologo /MD /W3 /GR /GX /I "..\..\include" /I "$(QTDIR)\include" /I "$(OCCINC)" /D "NDEBUG" /D "_USRDLL" /D "CAF_EXPORTS" /D "WNT" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "QT_DLL" /D "QT_THREAD_SUPPORT" /YX /FD /c
# SUBTRACT CPP /O<none>
...
# ADD LINK32 tkernel.lib tklcaf.lib tkcdf.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib qt$(QTVER).lib /nologo /dll /machine:I386 /out:"../../win32/bin/caf.dll" /libpath:"$(OCCLIB)" /libpath:"$(QTLIB)"
...
# PROP Intermediate_Dir "..\..\win32\objd\CAF"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
...
# ADD LINK32 odbc32.lib odbccp32.lib tkernel.lib tklcaf.lib tkcdf.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib qt$(QTVER).lib /nologo /dll /debug /machine:I386 /out:"../../win32/bind/caf.dll" /pdbtype:sept /libpath:"$(OCCLIBD)" /libpath:"$(QTLIBD)"
# SUBTRACT LINK32 /pdb:none
...
SOURCE=..\..\src\CAF\CAF.h

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Update $(InputName).h...
InputPath=..\..\src\CAF\CAF.h
InputName=CAF
...
SOURCE=..\..\src\CAF\CAF_Application.h

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).cxx...
InputPath=..\..\src\CAF\CAF_Application.h
...
SOURCE=..\..\src\CAF\CAF_Operation.h

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).cxx...
InputPath=..\..\src\CAF\CAF_Operation.h
...
SOURCE=..\..\src\CAF\CAF_Study.h

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).cxx...
InputPath=..\..\src\CAF\CAF_Study.h
InputName=CAF_Study
...
SOURCE=..\..\src\CAF\CAF_Tools.h

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Update $(InputName).h...
InputPath=..\..\src\CAF\CAF_Tools.h
InputName=CAF_Tools
...
SOURCE=..\..\src\CAF\CAF_Application.cxx
# End Source File
# Begin Source File

SOURCE=..\..\src\CAF\CAF_Operation.cxx
# End Source File
# Begin Source File

SOURCE=..\..\src\CAF\CAF_Study.cxx
# End Source File
# Begin Source File

SOURCE=..\..\src\CAF\CAF_Tools.cxx
# End Source File
# End Group
...
SOURCE=..\..\src\CAF\resources\CAF_images.po

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).qm...
InputPath=..\..\src\CAF\resources\CAF_images.po
...
SOURCE=..\..\src\CAF\resources\CAF_msg_en.po

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).qm...
InputPath=..\..\src\CAF\resources\CAF_msg_en.po
...
SOURCE=..\..\src\CAF\resources\redo.png

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Update $(InputName).png...
InputPath=..\..\src\CAF\resources\redo.png
InputName=redo
...
SOURCE=..\..\src\CAF\resources\undo.png

!IF  "$(CFG)" == "CAF - Win32 Release"

# Begin Custom Build - Update $(InputName).png...
InputPath=..\..\src\CAF\resources\undo.png
InputName=undo
