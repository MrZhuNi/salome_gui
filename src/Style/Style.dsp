...
# ADD LINK32 qt-mt333.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"..\..\win32\bin\Style.dll" /libpath:"$(QTLIB)"
...
# ADD LINK32 qt-mt333.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"..\..\win32\bind\Style.dll" /pdbtype:sept /libpath:"$(QTLIBD)"
...
SOURCE=.\SalomeStyle.h

!IF  "$(CFG)" == "Style - Win32 Release"

# Begin Custom Build - Update $(InputName).h...
InputPath=.\SalomeStyle.h
