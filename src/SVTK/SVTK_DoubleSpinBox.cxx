...
*/
class SVTK_DoubleSpinBoxValidator: public QDoubleValidator 
{
public:
  SVTK_DoubleSpinBoxValidator( SVTK_DoubleSpinBox* sb, const char* name );

  State validate( QString& str, int& pos ) const;

private:
  SVTK_DoubleSpinBox* spinBox;
};

SVTK_DoubleSpinBoxValidator::SVTK_DoubleSpinBoxValidator( SVTK_DoubleSpinBox* sb, const char* name ) 
: QDoubleValidator( sb ),
  spinBox( sb ) 
{
}
...
*/
QValidator::State SVTK_DoubleSpinBoxValidator::validate( QString& str, int& pos ) const 
{
  ...
  if ( overhead == 0 ) {
    ...
    if ( str.length() >= overhead && 
      ...
      state = QDoubleValidator::validate( str, pos );
      if ( state == Invalid ) {
        // simplified(), cf. SVTK_DoubleSpinBox::interpretText()
...
/*!
  ...
  convertion flag 'g' and initial value 0.00.
*/
SVTK_DoubleSpinBox::SVTK_DoubleSpinBox( QWidget* parent )
: QFrame(parent),
  QDblRangeControl() 
{
  initSpinBox();
...
/*!
  Destructor
*/
SVTK_DoubleSpinBox::~SVTK_DoubleSpinBox() 
{}

/*!
  Internal initialization.
*/
void SVTK_DoubleSpinBox::initSpinBox()
{
  wrap   = FALSE;
  edited = FALSE;
  ...
  validate = new SVTK_DoubleSpinBoxValidator( this, "validator" ); 
...
*/
QString SVTK_DoubleSpinBox::text() const
{
  return vi->text();
}
...
*/
QString SVTK_DoubleSpinBox::cleanText() const
{
...
*/
void SVTK_DoubleSpinBox::setSpecialValueText( const QString &text )
{
  specText = text;
  updateDisplay();
}
...
*/
QString SVTK_DoubleSpinBox::specialValueText() const
{
  if ( specText.isEmpty() )
    return QString::null;
  else
...
*/
void SVTK_DoubleSpinBox::setPrefix( const QString &text )
{
  pfix = text;
  updateDisplay();
}
...
/*!
  ...
  to the user.
*/
void SVTK_DoubleSpinBox::setSuffix( const QString &text )
{
  sfix = text;
  updateDisplay();
}
...
*/
QString SVTK_DoubleSpinBox::prefix() const
{
  if ( pfix.isEmpty() )
    return QString::null;
  else
...
*/
QString SVTK_DoubleSpinBox::suffix() const
{
  if ( sfix.isEmpty() )
    return QString::null;
  else
...
/*!
  ...
  turned off.
*/
void SVTK_DoubleSpinBox::setWrapping( bool on )
{
  wrap = on;
  updateDisplay();
}
...
*/
bool SVTK_DoubleSpinBox::wrapping() const
{
  return wrap;
}
...
/*!
  Reimplementation
*/
QSize SVTK_DoubleSpinBox::sizeHint() const
{
  ensurePolished();
  ...
  SVTK_DoubleSpinBox* that = (SVTK_DoubleSpinBox*)this;
...
*/
void SVTK_DoubleSpinBox::arrangeWidgets()
{
...
*/
void SVTK_DoubleSpinBox::setValue( double value )
{
...
*/
void SVTK_DoubleSpinBox::stepUp()
{
  if ( edited )
    interpretText();
...
*/
void SVTK_DoubleSpinBox::stepDown()
{
  if ( edited )
    interpretText();
...
/*!
  ...
  which have special meaning for the SVTK_DoubleSpinBox.
*/
bool SVTK_DoubleSpinBox::eventFilter( QObject* obj, QEvent* ev )
{
  if ( obj != vi )
    return FALSE;
...
/*!
  Reimplementation
*/
void SVTK_DoubleSpinBox::leaveEvent( QEvent* )
{
  if ( edited )
    interpretText();
}
...
/*!
  Reimplementation
*/
void SVTK_DoubleSpinBox::resizeEvent( QResizeEvent* )
{
  arrangeWidgets();
}
...
/*!
  Reimplementation
*/
void SVTK_DoubleSpinBox::wheelEvent( QWheelEvent * e )
{
  e->accept();
  static float offset = 0;
  static SVTK_DoubleSpinBox* offset_owner = 0;
...
*/
void SVTK_DoubleSpinBox::valueChange()
{
  selreq = hasFocus();
  updateDisplay();
  selreq = FALSE;
...
*/
void SVTK_DoubleSpinBox::rangeChange()
{
  updateDisplay();
}
...
*/
void SVTK_DoubleSpinBox::setValidator( const QValidator* v )
{
  if ( vi )
    vi->setValidator( v );
}
...
*/
const QValidator* SVTK_DoubleSpinBox::validator() const
{
...
/*!
  ...
  buttons accordingly.
*/
void SVTK_DoubleSpinBox::updateDisplay()
{
  ...
  vi->repaint( vi->contentsRect() ); // immediate repaint needed for some reason
  edited = FALSE;
...
/*!
  SVTK_DoubleSpinBox calls this after the user has manually edited the contents
...
*/
void SVTK_DoubleSpinBox::interpretText()
{
  bool ok = TRUE;
  bool done = FALSE;
  double newVal = 0;
  if ( !specialValueText().isEmpty() ) {
    QString s = QString(text()).simplified();
    QString t = QString(specialValueText()).simplified();
    if ( s == t ) {
      newVal = minValue();
      done = TRUE;
    }
...
QPushButton* SVTK_DoubleSpinBox::upButton() const
{
  return up;
}
...
*/
QPushButton* SVTK_DoubleSpinBox::downButton() const
{
  return down;
}
...
*/
QLineEdit* SVTK_DoubleSpinBox::editor() const
{
  return vi;
}
...
*/
void SVTK_DoubleSpinBox::textChanged()
{
...
QString SVTK_DoubleSpinBox::mapValueToText( double v )
{
  QString s;
...
*/
double SVTK_DoubleSpinBox::mapTextToValue( bool* ok )
{
  QString s = text();
  double newVal = s.toDouble( ok );
  if ( !(*ok) && !( prefix().isNull() && suffix().isNull() ) ) {// Try removing any pre/suffix
    s = cleanText();
...
*/
QString SVTK_DoubleSpinBox::currentValueText()
{
  QString s;
...
/*!
  Reimplementation
*/
void SVTK_DoubleSpinBox::setEnabled( bool on )
{
  bool b = isEnabled();
...
/*!
  Reimplementation
*/
void SVTK_DoubleSpinBox::styleChange( QStyle& old )
{
  setFrameStyle( Panel | Sunken );
  arrangeWidgets();
...
*/
void SVTK_DoubleSpinBox::setButtonSymbols( ButtonSymbols newSymbols )
{
...
*/
SVTK_DoubleSpinBox::ButtonSymbols SVTK_DoubleSpinBox::buttonSymbols() const
{
  return butSymbols;
}
...
/*!
  ...
  this, QAbstractButton::setPixmap() is able to avoid flicker e.g. when the
  spin box is resized in such a way that the height of the buttons
  does not change (common the default size policy).
*/
void SVTK_DoubleSpinBox::updateButtonSymbols()
{
  QString key( QString::fromLatin1( "$qt$SVTK_DoubleSpinBox$" ) );
  ...
  down->setIcon( QIcon( dnBm ) );
  up->setIcon( QIcon( upBm ) );
}

/*!
  Returns minimum value, reimplementaion
*/
double SVTK_DoubleSpinBox::minValue() 
{
...
*/
double SVTK_DoubleSpinBox::maxValue() 
{
...
*/
void SVTK_DoubleSpinBox::setMinValue( double minValue ) 
{
...
*/
void SVTK_DoubleSpinBox::setMaxValue( double maxValue ) 
{
...
*/
double SVTK_DoubleSpinBox::lineStep() 
{
...
/*!
  Sets step size
*/
void SVTK_DoubleSpinBox::setLineStep( double step ) 
{
...
*/
double SVTK_DoubleSpinBox::value()
{
  SVTK_DoubleSpinBox* that = ( SVTK_DoubleSpinBox* ) this;
  if ( edited ) {
...
void SVTK_DoubleSpinBox::selectAll()
{
