...
SOURCE=.\CAM_Application.cxx
# End Source File
# Begin Source File

SOURCE=.\CAM_DataModel.cxx
# End Source File
# Begin Source File

SOURCE=.\CAM_DataObject.cxx
# End Source File
# Begin Source File

SOURCE=.\CAM_Module.cxx
# End Source File
# Begin Source File

SOURCE=.\CAM_RootObject.cxx
# End Source File
# Begin Source File

SOURCE=.\CAM_Study.cxx
# End Source File
# End Group
...
SOURCE=.\CAM_Application.h

!IF  "$(CFG)" == "CAM - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).cxx...
InputPath=.\CAM_Application.h
...
SOURCE=.\CAM_DataModel.h

!IF  "$(CFG)" == "CAM - Win32 Release"

# Begin Custom Build - Generate moc_$(InputName).cxx...
InputPath=.\CAM_DataModel.h
...
SOURCE=.\CAM_DataObject.h

!IF  "$(CFG)" == "CAM - Win32 Release"

# Begin Custom Build - Update $(InputName).h...
InputPath=.\CAM_DataObject.h
...
SOURCE=.\CAM_RootObject.h

!IF  "$(CFG)" == "CAM - Win32 Release"

# Begin Custom Build - Update $(InputName).h...
InputPath=.\CAM_RootObject.h
...
SOURCE=.\resources\CAM_msg_en.po

!IF  "$(CFG)" == "CAM - Win32 Release"

# Begin Custom Build - Generate $(InputName).qm...
InputPath=.\resources\CAM_msg_en.po
