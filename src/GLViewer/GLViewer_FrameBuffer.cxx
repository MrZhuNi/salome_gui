...
GLViewer_FrameBuffer::GLViewer_FrameBuffer()
  : textureId( 0 ),
    fboId( 0 ),
    rboId( 0 ),
    myIsInitializeEXT ( false )
{
}
...
void GLViewer_FrameBuffer::release()
{
  if( !myIsInitializeEXT )
    return;
...
void GLViewer_FrameBuffer::bind()
{
  if( !myIsInitializeEXT )
    return;
...
void GLViewer_FrameBuffer::unbind()
{
  if( !myIsInitializeEXT )
    return;
